...
import { CalendarDays, Cake, Star, ArrowRight, ArrowLeft } from "lucide-react"

const items = [
  { key: "seasonal", icon: CalendarDays, color: "from-aqua to-ocean", link: "seasonal" },
  { key: "birthday", icon: Cake, color: "from-pink-400 to-rose-500", link: "birthday" },
  { key: "private", icon: Star, color: "from-violet-400 to-purple-600", link: "private" },
] as const
