...
import { Utensils, Coffee, IceCreamCone, ArrowRight, ArrowLeft } from "lucide-react"

const items = [
  { key: "restaurants", icon: Utensils, color: "from-rose-400 to-red-500", link: "restaurants" },
  { key: "cafes", icon: Coffee, color: "from-amber-400 to-orange-500", link: "cafes" },
  { key: "snacks", icon: IceCreamCone, color: "from-pink-400 to-fuchsia-500", link: "snacks" },
] as const

export default function FoodPage() {
  const { locale, content } = useI18n()
  const t = content.food
